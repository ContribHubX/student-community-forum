        ...
        <div className="relative z-10 flex flex-col justify-between flex-grow">
          <CardHeader className="flex flex-row items-center justify-between text-gray-900">
            <div className="flex items-center gap-1">
              ...
              {users.length > 3 && (
                <div className="ml-2 text-sm font-medium text-gray-300">+{users.length - 3} more</div>
              )}
            </div>
          ...
          <CardContent>
            <CardTitle className="mb-2 text-2xl font-bold text-accent-foreground">{room.name.substring(0, 25)}</CardTitle>
        ...
        <CardFooter className="flex flex-col items-start z-10 bg-primary backdrop-blur-sm p-4 space-y-4">
          ...
          <div className="flex items-center justify-between w-full">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-500 dark:text-gray-300">Next break in 32:10</span>
            </div>
