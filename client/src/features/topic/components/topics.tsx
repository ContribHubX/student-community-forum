...
const topic: Topic = {
    ...
    attachment: "https://static.vecteezy.com/system/resources/previews/035/742/223/non_2x/artificial-intelligent-icon-line-icon-for-your-website-mobile-presentation-and-logo-design-vector.jpg",
    createdBy: null,
    followerCount: 1100
} 
...
const TabItem = ({ onClick, isActive, name }: TabItemProp) => {
    ...
    return (
        <div className="cursor-pointer">
            ...
            <div className={`w-full h-[3px] bg-accent mt-2 ${isActive ? "block" : "hidden"}`}/>
        </div>
    )
}
