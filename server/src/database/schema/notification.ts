...
export const EntityType = mysqlEnum("entity_type", ["thread", "task", "question", "board"]);
export const NotificationType = mysqlEnum("type", ["like", "dislike", "comment", "reply", "request", "added"]);
